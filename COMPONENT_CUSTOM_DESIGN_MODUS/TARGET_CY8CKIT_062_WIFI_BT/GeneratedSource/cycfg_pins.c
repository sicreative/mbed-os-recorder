...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t CYBSP_IMU_INT1_config = 
{
	.outVal = 0,
	.driveMode = CY_GPIO_DM_OD_DRIVESLOW_IN_OFF,
	.hsiom = CYBSP_IMU_INT1_HSIOM,
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t CYBSP_IMU_INT1_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = CYBSP_IMU_INT1_PORT_NUM,
		.channel_num = CYBSP_IMU_INT1_PIN,
	};
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t CYBSP_IMU_INT2_config = 
{
	.outVal = 0,
	.driveMode = CY_GPIO_DM_OD_DRIVESLOW_IN_OFF,
	.hsiom = CYBSP_IMU_INT2_HSIOM,
	.intEdge = CY_GPIO_INTR_RISING,
	.intMask = 1UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t CYBSP_IMU_INT2_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = CYBSP_IMU_INT2_PORT_NUM,
		.channel_num = CYBSP_IMU_INT2_PIN,
	};
#endif //defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
const cy_stc_gpio_pin_config_t CYBSP_CSD_PXT0_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_ANALOG,
	.hsiom = CYBSP_CSD_PXT0_HSIOM,
	.intEdge = CY_GPIO_INTR_DISABLE,
	.intMask = 0UL,
	.vtrip = CY_GPIO_VTRIP_CMOS,
	.slewRate = CY_GPIO_SLEW_FAST,
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t CYBSP_CSD_PXT0_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = CYBSP_CSD_PXT0_PORT_NUM,
		.channel_num = CYBSP_CSD_PXT0_PIN,
	};
#endif //defined (CY_USING_HAL)
...
void init_cycfg_pins(void)
{
	...
	Cy_GPIO_Pin_Init(CYBSP_IMU_INT1_PORT, CYBSP_IMU_INT1_PIN, &CYBSP_IMU_INT1_config);
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&CYBSP_IMU_INT1_obj);
#endif //defined (CY_USING_HAL)

	Cy_GPIO_Pin_Init(CYBSP_IMU_INT2_PORT, CYBSP_IMU_INT2_PIN, &CYBSP_IMU_INT2_config);
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&CYBSP_IMU_INT2_obj);
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&CYBSP_CSD_PXT0_obj);
#endif //defined (CY_USING_HAL)
